    ...
    <div className="about-bottom">
      <div className="about-bottom__bottom">
        <div className="about-bottom__level">
          <p>LEVEL UP!</p>
          <p>
            If you're a serious gamer and know what you want out of your PC, why
            not customize your own Build Redux system? Pick your budget, select
            your favorite games, select the best components.
          </p>
        </div>
      ...
      <div className="about-bottom__top">
        <div className="about-bottom__top-contents">
          ...
          <p>
            Whether you are just starting out or a serious gamer, our PCs are
            built to the highest standard, to give you the best gaming
            experience. Pick your budget and view the default configuration.
            Looking for a little more? Why not customize it.
          </p>
        </div>
